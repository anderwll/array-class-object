...
const mediaTurma = listaAlunos.reduce(
  (result, prox) => result + prox.nota / listaAlunos.length,
  0
);
...
console.log(
  `Nome: ${melhorAluno[listaAlunos.length - 1].nome} - Nota: ${
    melhorAluno[listaAlunos.length - 1].nota
  }`
);
